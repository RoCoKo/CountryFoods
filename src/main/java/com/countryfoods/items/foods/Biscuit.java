...
public class Biscuit extends ItemFood implements IHasModel 
{
	public Biscuit(String name, int amount, float saturation, boolean isAnimalFood) 
	{
    ...
    public void addInformation(ItemStack stack, @Nullable World playerIn, List<String> tooltip, ITooltipFlag advanced)
    {
    	 if(GuiScreen.isShiftKeyDown()){
    		 tooltip.add(TextFormatting.GRAY + I18n.format("Polly wants a biscuit!", 0));
         }else{
