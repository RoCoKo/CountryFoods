...
public class RawPorkchopSlice extends ItemFood implements IHasModel 
{
	public RawPorkchopSlice(String name, int amount, float saturation, boolean isAnimalFood) 
	{
