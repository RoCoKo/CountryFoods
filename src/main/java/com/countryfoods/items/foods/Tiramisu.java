...
public class Tiramisu extends ItemFood implements IHasModel 
{
	public Tiramisu(String name, int amount, float saturation, boolean isAnimalFood) 
	{
    ...
    public void addInformation(ItemStack stack, @Nullable World playerIn, List<String> tooltip, ITooltipFlag advanced)
    {
    	 if(GuiScreen.isShiftKeyDown()){
    		 tooltip.add(TextFormatting.GRAY + I18n.format("The Tiramisu was found in 20th century, in Italy.", 0));
         }else{
