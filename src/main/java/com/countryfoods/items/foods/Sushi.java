...
public class Sushi extends ItemFood implements IHasModel 
{
	public Sushi(String name, int amount, float saturation, boolean isAnimalFood) 
	{
    ...
    public void addInformation(ItemStack stack, @Nullable World playerIn, List<String> tooltip, ITooltipFlag advanced)
    {
    	 if(GuiScreen.isShiftKeyDown()){
    		 tooltip.add(TextFormatting.GRAY + I18n.format("The modern Sushi was became popular in 19th century, in Tokyo, Japan.", 0));
         }else{
