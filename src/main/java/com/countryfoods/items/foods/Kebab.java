...
public class Kebab extends ItemFood implements IHasModel 
{
	public Kebab(String name, int amount, float saturation, boolean isAnimalFood) 
	{
    ...
    public void addInformation(ItemStack stack, @Nullable World playerIn, List<String> tooltip, ITooltipFlag advanced)
    {
    	 if(GuiScreen.isShiftKeyDown()){
    		 tooltip.add(TextFormatting.GRAY + I18n.format("The Kebab was found in 18th century, in Ottoman Empire.", 0));
         }else{
