...
public class LettuceSeeds extends Item implements IHasModel, IPlantable 
{
    public LettuceSeeds(String name)
    {
   ...
   public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ){
       ...
       if(facing == EnumFacing.UP
           ...
           worldIn.setBlockState(pos.up(), ModBlocks.LETTUCE_PLANT.getDefaultState());
           stack.shrink(1);
   ...
   public IBlockState getPlant(IBlockAccess world, BlockPos pos) {
        return ModBlocks.LETTUCE_PLANT.getDefaultState();
   }
    ...
    public void addInformation(ItemStack stack, @Nullable World playerIn, List<String> tooltip, ITooltipFlag advanced)
    {
    	 if(GuiScreen.isShiftKeyDown()){
    		 tooltip.add(TextFormatting.GRAY + I18n.format("A bunch of lovely Lactuva Sativa seeds, yay!", 0));
         }else{
